...
public class ForcedChunkManager {
	...
	private static final Map<ResourceLocation, TicketController> controllers = new HashMap<>();
	...
	public static boolean hasForcedChunks(ServerLevel level) {
		ForcedChunksSavedData data = level.getDataStorage().get(new SavedData.Factory<>(ForcedChunksSavedData::new, ForcedChunksSavedData::load, null), "chunks");
